...
export default class Sidebar extends React.Component {
  ...
  render() {
    ...
    return (
		<div id="sidebar">
			<select className={(this.props.isMovieDetailsShown) ? 'hide' : ''} name="genres" id="genres" defaultValue={this.props.selectedGenres} onChange={this.handleGenreChange} multiple={true}>
